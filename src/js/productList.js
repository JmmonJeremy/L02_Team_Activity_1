...
export default class ProductList {
  ...
  prepareTemplate(templateClone, product) {
    ...
    templateClone.querySelector(".product-detail>h3").innerHTML =
      product.Brand.Name;
    templateClone.querySelector(".product-detail>h2").innerHTML =
      product.NameWithoutBrand;
    templateClone.querySelector(".product-detail>img").alt =
      product.NameWithoutBrand;
    templateClone.querySelector(".product-detail>img").src =
      product.Images.PrimaryLarge;
    templateClone.querySelector(".discount-flag").alt = "discount flag star";
    templateClone.querySelector(".discount-flag").src =
      "../images/discount.svg";
    templateClone.querySelector(".flag-percent").innerHTML =
      100 - Math.ceil((product.ListPrice / product.SuggestedRetailPrice) * 100);
    templateClone.querySelector(
      ".product-card__orginal-price"
    ).innerHTML += product.SuggestedRetailPrice.toFixed(2);
    templateClone.querySelector(".product-card__discount").innerHTML +=
      (product.SuggestedRetailPrice - product.ListPrice).toFixed(2) + "!!!";
    templateClone.querySelector(".price-highlight").innerHTML +=
      product.FinalPrice;
    templateClone.querySelector(".product__color").innerHTML +=
      product.Colors[0].ColorName;
    templateClone.querySelector(".product__description").innerHTML +=
      product.DescriptionHtmlSimple;
    templateClone.querySelector(".product__reviews").innerHTML +=
