...
export default class Admin {
    ...
    showLogin() {
        ...
        loginBttn.addEventListener("click", this.login({email, password}, this.showOrders.bind(this)));
    }
    ...
    async renderOrderList(list) {
        ...
        //Order Date
        clonedTemplateNode.querySelector(".order-date")
        .innerHTML = new Date(order.orderDate).toDateString("en-US");
        //Order Quantity
        clonedTemplateNode.querySelector(".order-quantity")
        .textContent = itemQuantity;
        //Order Items
        clonedTemplateNode.querySelector(".order-items")
        .innerHTML = productItems        
        //Order Amount
        clonedTemplateNode.querySelector(".order-amount")
        .innerHTML = "$" + parseFloat(order.orderTotal).toFixed(2);
        console.log(clonedTemplateNode);
